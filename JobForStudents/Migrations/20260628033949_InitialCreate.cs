    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 2, "10 tin tuyển dụng;Xem duyệt ứng viên;Truy cập hồ sơ ứng viên không giới hạn", "Gói tối ưu cho doanh nghiệp vừa và nhỏ, nâng cao hiển thị.", 30, true, 10, "Business Premium", 99000m },
                    { 3, "1 tin tuyển dụng với độ ưu tiên cao nhất;Bài đăng giới hạn 7 ngày;Sử dụng 1 lần", "Đăng 1 bài với độ ưu tiên cao nhất, giới hạn trong 7 ngày.", 7, true, 1, "Business VIP", 30000m }
                });
